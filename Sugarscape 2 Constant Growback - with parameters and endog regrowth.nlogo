...
to turtle-setup ;; turtle procedure
  ...
  set sugar random-in-range min-sugar max-sugar
...
to turtle-eat ;; turtle procedure
  ;; metabolize some sugar, and eat a fraction of the sugar on the current patch
  set sugar (sugar - metabolism + ((psugar - metabolism) * cons-ratio) )
  set psugar max (list 0.1 (psugar - metabolism - ((psugar - metabolism) * cons-ratio)))
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot sum [sugar] of turtles"
